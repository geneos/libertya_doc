1. Acceder a la opción del menú ****Gestión de Manufactura →  Gestión de la Producción →  Revisión a detalle**. El sistema presenta una ventana como lo muestra la Imagen Oper014.

![Geneos](img/operaciones/ly_om_revdetalle.png)

Imagen Oper014: Revisión a detalle

En el encabezado se pueden seleccionar: Artículo, Almacén, Recurso y el período de tiempo para el que se quiere analizar las demandas y los suministros. Alguno de estos parámetros pueden ser dejados en blanco.
